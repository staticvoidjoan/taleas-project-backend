...
class ReportFunction extends Construct{
    constructor(scope, id, props){
        ...
        const reportUser = createNodejsFunction(this, "reportUser", "../resources/handlers/reportHandlers/reportUser.js", "reportUser");
        ...
        const reportUserResource = new apigateway.Resource(this, "ReportUserResource", {
            parent: reports,
            pathPart: "report-user"
        })

        reports.addMethod("POST", new apigateway.LambdaIntegration(createReport));

        reportUserResource.addMethod("POST", new apigateway.LambdaIntegration(reportUser));
