...
const {ReportFunction} = require('./report-function');
const {ConfirmCodeFunction} = require ("./confirmCode-function")
class TaleasProjectBackendStack extends Stack {
  ...
  constructor(scope, id, props) {
    ...
    new ReportFunction(this, "ReportFunction", {api});
    new ConfirmCodeFunction(this, "ConfirmCodeFunction", {api})
  }
}
