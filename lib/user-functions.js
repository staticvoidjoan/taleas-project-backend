...
class UserFunctions extends Construct {
  constructor(scope, id, props) {
    ...
    const updateUser = createNodejsFunction(
        this,
        "updateUser",
    ...
    const user = new apigateway.Resource(
      this,
      "UserById",
      {
        parent: users,
    ...
    const completeProfile = new apigateway.Resource(this, "UserCompleteProfile", {parent: props.api.root, pathPart: "{id}"} )
    ...
    completeProfile.addMethod('PUT', new apigateway.LambdaIntegration(profileComplete));

    const dislike = new apigateway.Resource(
        this,
        "DislikeResource",
        {
          parent: props.api.root,
      ...
      const like = new apigateway.Resource(
        this,
        "LikeResource",
        {
          parent: props.api.root,
