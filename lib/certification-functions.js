...
class CertificationFunctions extends Construct {
  constructor(scope, id, props) {
    ...
    const certifications = new apigateway.Resource(
      this,
    ...
    certification.addMethod(
      "PUT",
      new apigateway.LambdaIntegration(updateCertification),
      {
    ...
    certification.addMethod(
      "DELETE",
      new apigateway.LambdaIntegration(deleteCertification),
      {
        authorizer: authorizer,
      }
    );
    certification.addMethod(
      "POST",
      new apigateway.LambdaIntegration(createCertification),
      {
        authorizer: authorizer,
      }
    );
