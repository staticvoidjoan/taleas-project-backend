...
class EmployerFunction extends Construct {
  constructor(scope, id, props) {
    ...
    const createEmployer = createNodejsFunction(this, "createEmployer", "../resources/handlers/employerHandler/createEmployer.js", "createEmployer");

    const getEmployerById = createNodejsFunction(this, "getEmployerById", "../resources/handlers/getEmployerById.js", "getEmployerById");

    const deleteEmployer = createNodejsFunction(this, "deleteEmployer", "../resources/handlers/employerHandler/deleteEmployer.js");

    const updateEmployer = createNodejsFunction(this, "updateEmployer", "../resources/handlers/employerHandler/updateEmployer.js", "updateEmployer");

    const likeUser = createNodejsFunction(this, "likeUser", "../resources/handlers/employerHandler/likeUser.js", "likeUser");
