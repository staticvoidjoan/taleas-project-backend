...
class EmployerFunction extends Construct {
  constructor(scope, id, props) {
    ...
    const unmatchEmployee = createNodejsFunction(this, "unmatchEmployee", "../resources/handlers/employerHandlers/unmatchEmployee.js", "unmatchEmployee");
    ...
    const employerEmail = new apigateway.Resource(this, "EmployerEmailRes", {
        parent: props.api.root,
        pathPart: "employerByEmail",
    });
    ...
    const unmatchEmployeeResource = new apigateway.Resource(this, "UnmatchEmployeeResource", {
        parent: props.api.root,
        pathPart: "unmatch-employee",
        requestParameters: {
            "method.request.querystring.employeerId": true,
            "method.request.querystring.employeeId": true,
        },
    });
    ...
    unmatchEmployeeResource.addMethod("PUT", new apigateway.LambdaIntegration(unmatchEmployee), {
    });
  }
}
